...
public interface PurchaseRepository extends JpaRepository<Purchase, Long> {
    ...
    @Query(value = "SELECT purchased_post_id, sale_post_id, sale_thumbnail_img_url, sale_name, saler_nickname, purchased_at FROM purchase WHERE(purchaser_data_id=:purchaser_data_id)"
            , nativeQuery = true)
