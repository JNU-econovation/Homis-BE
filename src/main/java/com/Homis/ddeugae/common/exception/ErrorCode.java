...
public enum ErrorCode {
    ...
    BLOB_FAILED_UPLOAD_IMG(HttpStatus.INTERNAL_SERVER_ERROR, "005_BLOB_FAILED_UPLOAD_IMG", "Blob Storage 업로드 실패"),
    UNKNOWN_FAILED_UPLOAD_IMG(HttpStatus.INTERNAL_SERVER_ERROR, "006_UNKNOWN_FAILED_UPLOAD_IMG", "알 수 없는 파일 업로드 오류");
